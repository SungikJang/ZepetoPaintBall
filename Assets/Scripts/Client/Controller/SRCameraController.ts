...
export default class SRCameraController extends ZepetoScriptBehaviour {
    ...
    Update(){
        if(ZepetoPlayers.instance.LocalPlayer) {
            this.gameObject.transform.rotation = ZepetoPlayers.instance.LocalPlayer.zepetoCamera.camera.gameObject.transform.rotation
        }
    }
    ...
    * SetPlayerParent(){
       while(true){
           if(ZepetoPlayers.instance.LocalPlayer){
               this.gameObject.transform.SetParent(ZepetoPlayers.instance.LocalPlayer.zepetoPlayer.character.gameObject.transform)
